 ...
 *
 * NOTE: This file is byte-identical with the wallet's
 * `myqrlwallet-frontend/src/utils/signing/ctx.ts`. Any divergence is a
 * cross-repo bug that will surface as fixture mismatches in both test
 * suites; keep them in lock-step.
 */
